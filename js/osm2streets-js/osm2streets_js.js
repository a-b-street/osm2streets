...
export class JsDebugStreets {
    ...
    static __wrap(ptr) {
        const obj = Object.create(JsDebugStreets.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_jsdebugstreets_free(ptr);
    }
    /**
    * @returns {string}
    */
    getLabel() {
        try {
            ...
            wasm.jsdebugstreets_getLabel(retptr, this.ptr);
    ...
    */
    getNetwork() {
        const ret = wasm.jsdebugstreets_getNetwork(this.ptr);
    ...
    */
    toDebugGeojson() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jsdebugstreets_toDebugGeojson(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            let v0;
            if (r0 !== 0) {
...
export class JsStreetNetwork {
    ...
    static __wrap(ptr) {
        const obj = Object.create(JsStreetNetwork.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_jsstreetnetwork_free(ptr);
    }
    /**
    ...
    */
    constructor(osm_xml_input, clip_pts_geojson, input) {
        try {
            ...
            return JsStreetNetwork.__wrap(r0);
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
    ...
    */
    toGeojsonPlain() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jsstreetnetwork_toGeojsonPlain(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    * @returns {string}
    */
    toLanePolygonsGeojson() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jsstreetnetwork_toLanePolygonsGeojson(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    * @returns {string}
    */
    toLaneMarkingsGeojson() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jsstreetnetwork_toLaneMarkingsGeojson(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    toIntersectionMarkingsGeojson() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jsstreetnetwork_toIntersectionMarkingsGeojson(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    toGraphviz() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jsstreetnetwork_toGraphviz(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    getDebugSteps() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jsstreetnetwork_getDebugSteps(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    debugClockwiseOrderingGeojson() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jsstreetnetwork_debugClockwiseOrderingGeojson(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    * @returns {string}
    */
    debugMovementsFromLaneGeojson(road, index) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jsstreetnetwork_debugMovementsFromLaneGeojson(retptr, this.ptr, road, index);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('osm2streets_js_bg.wasm', import.meta.url);
    }
    const imports = getImports();
